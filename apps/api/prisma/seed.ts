...
async function main() {
          ...
          create: [
            {
              ...
              pspCostRate: new Prisma.Decimal("0.0500"),
  ...
  for (const channel of seededChannels) {
    await prisma.agentChannel.upsert({
      ...
      update: {
        isEnabled: true,
        agentFeeRate: new Prisma.Decimal("0.1000"),
        agentFixedFee: new Prisma.Decimal("0.00"),
        note: "Seed platform authorization",
      },
      create: {
        agentId: agent.id,
  ...
  const order = await prisma.order.upsert({
    ...
    create: {
      ...
      currency: "USD",
      feeAmount: new Prisma.Decimal("12.00"),
      netAmount: new Prisma.Decimal("83.60"),
      merchantFeeAmount: new Prisma.Decimal("12.00"),
      agentProfitAmount: new Prisma.Decimal("2.00"),
      platformProfitAmount: new Prisma.Decimal("5.00"),
      pspCostAmount: new Prisma.Decimal("5.00"),
      merchantNetBeforeReserve: new Prisma.Decimal("88.00"),
      rollingReserveAmount: new Prisma.Decimal("4.40"),
      merchantAvailableAmount: new Prisma.Decimal("83.60"),
      status: "PAID",
  ...
  if (!walletTransaction) {
    await prisma.walletTransaction.create({
      data: {
        ...
        merchantId: merchant.id,
        type: "PAYMENT_IN",
        amount: new Prisma.Decimal("83.60"),
